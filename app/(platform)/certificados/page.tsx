...
export default function Page() {
  ...
  useEffect(() => {
    api.get<any>("/certificates?page=1&limit=20")
      .then(res => {
  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "#1e293b", margin: 0 }}>Certificados</h1>
        <p style={{ color: "#64748b", fontSize: 14, marginTop: 4 }}>Certificados emitidos</p>
      </div>
