                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              <button
                                onClick={async () => {
                                  await apiClient.patch(
                                    `/declarations/documents/${d.id}/approve`,
                                    { approved: true },
                                  );
                                  load();
                                }}
                            ...
                            {d.status === 'APPROVED' && (
                              <button
                                onClick={async () => {
                                  await apiClient.patch(
                                    `/declarations/documents/${d.id}/generate`,
                                    {},
                                  );
                                  load();
                                }}
                ...
                <button
                  onClick={async () => {
                    await apiClient.post(
                      '/declarations/work/trigger/periodic',
                      {},
                    );
                    load();
                  }}
                          ...
                          {s.status === 'SUBMITTED' && (
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button
                                onClick={async () => {
                                  await apiClient.patch(
                                    `/declarations/work/submissions/${s.id}/review`,
                                    { approved: true },
                                  );
                                  load();
                                }}
