                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-blue-200 text-sm">
                      {myPlan.currentRole && (
                        <span>{myPlan.currentRole.name}</span>
                      )}
                      {myPlan.targetRole && (
                        <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {(myPlan.readiness?.recommendedCourses.length ?? 0) > 0 && (
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div className="space-y-2">
                      {myPlan
                        .readiness!.recommendedCourses.slice(0, 4)
                        .map((c) => (
                          <div
                            key={c.id}
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-xs text-gray-400">
                    {
                      myPlan.goals.filter((g) => g.status === 'COMPLETED')
                        .length
                    }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {myPlan.goals.map((g) => (
                      <GoalCard
                        key={g.id}
                        goal={g}
                        onUpdateProgress={handleGoalProgress}
                      />
                    ))}
                  </div>
                )}
