                  ...
                  <div className="flex items-start gap-6">
                    <div className="flex-1">
                      ...
                      {rcfg && gap && (
                        <div className="mb-4">
                          ...
                          <p className="text-xs text-gray-400 mt-1">
                            {gap.metRequirements}/{gap.totalRequirements}{' '}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Object.entries(myMap.byType ?? {}).map(
                          ([type, skills]) => {
                            const cfg = TYPE_CONFIG[type as SkillType];
                            const avg = skills.length
                              ? +(
                                  skills.reduce(
                                    (a: number, s: EmployeeSkill) =>
                                      a + s.currentLevel,
                                    0,
                                  ) / skills.length
                                ).toFixed(1)
                            ...
                            return (
                              ...
                              >
                                ...
                                <span
                                  className={`text-xs ${cfg.color} opacity-70`}
                                >
                                  {avg}
                                </span>
                              </div>
            ...
            {gap.recommendedCourses.length > 0 && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                <h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-2">
                  <BookOpen size={15} className="text-blue-600" /> Cursos
                  Recomendados
                </h3>
