  ...
  return (
    <>
      ...
      <div>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        maxWidth: 240,
                        borderLeft:
                          status === 'live' ? '4px solid #dc2626' : undefined,
                      }}
                    >
                      <div
                        style={{
        ...
        >
          <button onClick={() => setTab('live')} style={tabBtn(tab === 'live')}>
            🎥 Todas as Aulas
          </button>
          <button
        ...
        {tab === 'recordings' &&
          (filtered.length === 0 ? (
            ...
            >
              {filtered.map((lc) => {
                const embedUrl = lc.recordingUrl
                  ? getEmbedUrl(lc.recordingUrl)
                  : null;
                return (
                  <div
                    key={lc.id}
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        style={{ margin: 0, fontSize: 11.5, color: '#94a3b8' }}
                      >
