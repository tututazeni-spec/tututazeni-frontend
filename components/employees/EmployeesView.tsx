...
//
// Extraído de app/(platform)/employees/page.tsx para poder ser reutilizado
// como separador de app/(platform)/users/page.tsx — módulo "Utilizadores"
// único na sidebar, que integra Utilizadores + Colaboradores + Permissões
// por Cargos sem fundir dados (cada um continua a bater no seu próprio
// controller). A rota standalone /employees continua a existir.
// ─────────────────────────────────────────────────────────────────────────────
...
export function EmployeesView() {
  ...
  const handleExport = async () => {
    try {
      ...
      reportError(e, { source: 'EmployeesView.handleExport' });
    }
  };
