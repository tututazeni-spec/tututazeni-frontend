// components/engagement/atoms.tsx
// Primitivos de UI partilhados pelos separadores do módulo — puramente
// apresentacionais. Extraídos de app/(platform)/engagement/page.tsx.
...
export function Avatar({ name, url, size = 8 }: AvatarProps) {
  ...
  return url ? (
    ...
    <div
      className={`w-${size} h-${size} rounded-full bg-gradient-to-br from-violet-500 to-pink-500
