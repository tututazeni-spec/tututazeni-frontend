...
//
// Extraído de app/(platform)/competency-map/page.tsx para poder ser
// reutilizado como separador de app/(platform)/competencies/page.tsx —
// módulo "Competências" único na sidebar, que integra Competências +
// Mapa de Competências sem fundir dados (cada um continua a bater no seu
// próprio controller: /competencies vs /competency-map). A rota
// standalone /competency-map continua a existir.
// ─────────────────────────────────────────────────────────────────────────────
...
export function CompetencyMapView() {
